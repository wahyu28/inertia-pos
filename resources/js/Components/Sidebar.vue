<template>
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['categories.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/categories" :class="{ 'active': $page.url.startWith('/apps/categories') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['products.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/products" :class="{ 'active': $page.url.startWith('/apps/products') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['customers.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/customers" :class="{ 'active': $page.url.startWith('/apps/customers') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/transactions" :class="{ 'active': $page.url.startWith('/apps/transactions') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['sales.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/sales" :class="{ 'active': $page.url.startWith('/apps/sales') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['profits.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/profits" :class="{ 'active': $page.url.startWith('/apps/profits') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['roles.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/roles" :class="{ 'active': $page.url.startWith('/apps/roles') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['permissions.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/permissions" :class="{ 'active': $page.url.startWith('/apps/permissions') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['users.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/users" :class="{ 'active': $page.url.startWith('/apps/users') }">
