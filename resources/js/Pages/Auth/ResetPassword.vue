<template>
    <Head>Update Password - Aplikasi Kasir</Head>
    <div class="col-md-4">
        <div class="fade-in">
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" v-model="form.password_confirmation" :class="{ 'is-invalid': errors.password_confirmation }" placeholder="Password Confirmation">
                            </div>
                            <div class="row">
                                <div class="col-12">
